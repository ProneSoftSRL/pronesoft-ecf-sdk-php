...
class DocumentsReceivedApi
{
     ...
     * @return \PronesoftEcfSdk\Model\ReceivedDocument|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\ReceivedDocument|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\ReceivedDocument',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\ReceivedDocument';
        $request = $this->getReceivedDocumentByIdRequest($id, $x_tenant_id, $contentType);
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\GetReceivedDocumentStatsBySupplier200ResponseInner[]|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\GetReceivedDocumentStatsBySupplier200ResponseInner[]|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReceivedDocumentStatsBySupplierWithHttpInfo($x_tenant_id = null, string $contentType = self::contentTypes['getReceivedDocumentStatsBySupplier'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\GetReceivedDocumentStatsBySupplier200ResponseInner[]',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\GetReceivedDocumentStatsBySupplier200ResponseInner[]';
        $request = $this->getReceivedDocumentStatsBySupplierRequest($x_tenant_id, $contentType);
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\ReceivedDocumentStatsResponse|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\ReceivedDocumentStatsResponse|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReceivedDocumentStatsSummaryWithHttpInfo($x_tenant_id = null, string $contentType = self::contentTypes['getReceivedDocumentStatsSummary'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\ReceivedDocumentStatsResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\ReceivedDocumentStatsResponse';
        $request = $this->getReceivedDocumentStatsSummaryRequest($x_tenant_id, $contentType);
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\ReceivedDocumentListResponse|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\ReceivedDocumentListResponse|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listReceivedDocumentsWithHttpInfo($x_tenant_id = null, $ecf = null, $type = null, $status = null, $supplier_rnc = null, $amount_from = null, $amount_to = null, $processed = null, $date_from = null, $date_to = null, $page = 1, $limit = 10, string $contentType = self::contentTypes['listReceivedDocuments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\ReceivedDocumentListResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\ReceivedDocumentListResponse';
        $request = $this->listReceivedDocumentsRequest($x_tenant_id, $ecf, $type, $status, $supplier_rnc, $amount_from, $amount_to, $processed, $date_from, $date_to, $page, $limit, $contentType);
