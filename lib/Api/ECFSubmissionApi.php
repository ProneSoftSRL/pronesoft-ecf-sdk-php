...
class ECFSubmissionApi
{
     ...
     * @return \PronesoftEcfSdk\Model\EcfStatsResponse|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\EcfStatsResponse|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\EcfStatsResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\EcfStatsResponse';
        $request = $this->getEcfStatsRequest($environment, $x_tenant_id, $contentType);
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\EcfStatusResponse|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\EcfStatusResponse|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEcfStatusWithHttpInfo($environment, $id, $x_tenant_id = null, string $contentType = self::contentTypes['getEcfStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\EcfStatusResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\EcfStatusResponse';
        $request = $this->getEcfStatusRequest($environment, $id, $x_tenant_id, $contentType);
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\GetEcfSubmissionHistory200Response|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\GetEcfSubmissionHistory200Response|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEcfSubmissionHistoryWithHttpInfo($environment, $x_tenant_id = null, $page = 1, $limit = 20, string $contentType = self::contentTypes['getEcfSubmissionHistory'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\GetEcfSubmissionHistory200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\GetEcfSubmissionHistory200Response';
        $request = $this->getEcfSubmissionHistoryRequest($environment, $x_tenant_id, $page, $limit, $contentType);
     ...
     *
     * @param  \PronesoftEcfSdk\Model\Environment $environment environment (required)
     * @param  \PronesoftEcfSdk\Model\ElectronicDocument $electronic_document electronic_document (required)
     * @param  string|null $x_tenant_id UUID de la empresa asociada (sucursal). Incluir SOLO cuando se actúa en nombre de una sucursal. Omitir cuando se actúa como empresa principal. (optional)
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\EcfSubmitResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\RateLimitErrorResponse
     */
     ...
     *
     * @param  \PronesoftEcfSdk\Model\Environment $environment (required)
     * @param  \PronesoftEcfSdk\Model\ElectronicDocument $electronic_document (required)
     * @param  string|null $x_tenant_id UUID de la empresa asociada (sucursal). Incluir SOLO cuando se actúa en nombre de una sucursal. Omitir cuando se actúa como empresa principal. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitEcf'] to see the possible values for this operation
     *
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\EcfSubmitResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\ErrorResponse|\PronesoftEcfSdk\Model\RateLimitErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitEcfWithHttpInfo($environment, $electronic_document, $x_tenant_id = null, string $contentType = self::contentTypes['submitEcf'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\EcfSubmitResponse',
                        $request,
                        $response,
                    );
                case 400:
                ...
                case 429:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\RateLimitErrorResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\EcfSubmitResponse';
        $request = $this->submitEcfRequest($environment, $electronic_document, $x_tenant_id, $contentType);
