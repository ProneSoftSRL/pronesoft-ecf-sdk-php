...
class CommercialApprovalsApi
{
     ...
     * @return \PronesoftEcfSdk\Model\ApprovalItem|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\ApprovalItem|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\ApprovalItem',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\ApprovalItem';
        $request = $this->getCommercialApprovalByIdRequest($id, $x_tenant_id, $contentType);
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PronesoftEcfSdk\Model\ApprovalListResponse|\PronesoftEcfSdk\Model\ErrorResponse
     */
     ...
     * @throws \PronesoftEcfSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PronesoftEcfSdk\Model\ApprovalListResponse|\PronesoftEcfSdk\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listCommercialApprovalsWithHttpInfo($x_tenant_id = null, $ecf = null, $type = null, $status = null, $date_from = null, $date_to = null, $page = 1, $limit = 10, string $contentType = self::contentTypes['listCommercialApprovals'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PronesoftEcfSdk\Model\ApprovalListResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PronesoftEcfSdk\Model\ApprovalListResponse';
        $request = $this->listCommercialApprovalsRequest($x_tenant_id, $ecf, $type, $status, $date_from, $date_to, $page, $limit, $contentType);
